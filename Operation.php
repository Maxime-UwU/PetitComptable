...
<div class="containerOperation">
    <form method="post" action="controllerOperation.php">
        <div class="formulaireOperation">
            ...
            <input type="number" step="0" name="Montant" placeholder="Entrez un montant" autocomplete="off"/><br/>
            ...
            <input type="submit" name="operationBtn" value="valider" onclick="location.href='dashboard.php';"/>
        </div>
    </form>
