...
INSERT INTO `Compte_bancaire` (`IDB`, `IDuser`, `Type`, `Provision`, `DeviseCompte`, `NOMcompte`)
VALUES (1, 1, 'courant', 1000, 'USD', 'Livret A'),
...
INSERT INTO `Opération` (`IDop`, `IDB`, `IDc`, `NOMop`, `MONTANTop`, `DATEop`)
VALUES (1, 1, 1, 'MCdo', 16, '2022-01-24'),
