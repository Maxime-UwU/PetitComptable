...
if( isset($_POST['creationCompteBtn'] ) ) {
    ...
    else if (empty($Nom) || empty($Provision) || empty($Type) || empty($Devise))
    {
    ...
    $req = $db->prepare( 'INSERT INTO Compte_bancaire (IDuser, NOMcompte, Provision, Type, DeviseCompte)
    VALUES (:IDuser, :NOMcompte, :Provision, :TypeCompte, :DeviseCompte)' );
